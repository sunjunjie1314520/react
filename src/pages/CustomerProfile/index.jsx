...
export default class index extends Component {
    constructor(){
        ...
        this.state = {
            ...
            items5: ['潜在客户 Potential Customers','普通客户 Ordinary','大客户 Key Account','设计师 Designer','重要客户 VIP'],
            index5: 0,

            items6: ['下拉菜单1','下拉菜单2','下拉菜单3','下拉菜单4','下拉菜单5'],
            index6: 6,

            items7: ['中小户型', '大户型', '复式/双拼', '独栋别墅', '样板房', '商业空间', '其他'],
            index7: 8,

            items8: ['现代/简约', '新/中式', '新/古典', '古典/欧式', '乡村/美式', '意式/轻奢', '北欧', '东南亚','地中海','其他'],
            index8: 0,
